...
\begin{figure}[H]
    ...
    \caption{evolution de la loss du cvae}
\end{figure}

\subsection{Résultats CVAE}
Pour vérifier les résultats du CVAE on a fait trois tests
...
\begin{figure}[H]
    ...
    \label{fig:génération_lunettes}
\end{figure}
Des visages apparraissent au centre, le CVAE a appris la forme des viasges et leurs emplacements. Des lunettes de soleils apparaissent bien, des lunettes de vues apparaissent un peu et aussi des fois des formes sombres au niveau des yeux ou des contours de lunettes apparaissent legerement

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{gen_CVAE_bals.png}
    \caption{Générations aléatoires chauve}
    \label{fig:génération_bald}
\end{figure}

On génére des vecteurs aléatoires pour $\mu$ et $\lambda$, ainsi qu'un vecteur de 0 avec un 1 pour les features que l'on veut
